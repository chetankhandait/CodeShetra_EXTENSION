...
const g = window,
  ...
  Z = (t, i) => {
    ...
    return [void 0 !== S ? S.createHTML(h) : h, e];
  };
class F {
  ...
  return (
    (null == l ? void 0 : l.constructor) !== a &&
      ...
      void 0 !== e
        ...
        : (s.k = l)),
    void 0 !== l && (i = G(t, l._$AS(t, i.values), l, e)),
    i
  );
}
class K {
  ...
  M(t) {
    ...
    for (; void 0 !== l; ) {
      if (r === l.index) {
        let i;
        2 === l.type
          ? (i = new Q(n, n.nextSibling, this, t))
          : 1 === l.type
          ? (i = new l.ctor(n, l.name, l.strings, this, t))
          : 6 === l.type && (i = new et(n, this, t)),
          this._$AV.push(i),
          (l = e[++h]);
      }
...
class Q {
  ...
  O(t) {
    ...
    const { values: s, _$litType$: e } = t,
      o =
        "number" == typeof e
          ? this._$AC(t)
          : (void 0 === e.el && (e.el = F.createElement(e.h, this.options)), e);
  ...
  _$AC(t) {
    ...
    return void 0 === i && J.set(t.strings, (i = new F(t))), i;
  }
  j(t) {
    ...
    for (const o of t)
      e === i.length
        ? i.push((s = new Q(this.L(A()), this.L(A()), this, this.options)))
        : (s = i[e]),
        s._$AI(o),
        e++;
...
class st extends X {
  ...
  _$AI(t, i = this) {
    var s;
    if ((t = null !== (s = G(this, t, i, 0)) && void 0 !== s ? s : q) === D)
      return;
    const e = this._$AH,
      o =
        (t === q && e !== q) ||
...
(ut.finalized = !0),
  ...
  null === (ht = globalThis.litElementHydrateSupport) ||
    void 0 === ht ||
    ht.call(globalThis, { LitElement: ut });
...
(null !== (lt = globalThis.litElementVersions) && void 0 !== lt
  ? lt
...
export {
  o as CSSResult,
  ut as LitElement,
  _ as ReactiveElement,
  at as UpdatingElement,
  dt as _$LE,
  ot as _$LH,
  h as adoptStyles,
  r as css,
